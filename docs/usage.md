...
To see more details on the available syntax, see [here](syntax/index.md). Please note, one can only filter based on Boolean values.
...
To see more details on the available syntax, see [here](syntax/index.md)
